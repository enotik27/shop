					...
					<div class="row main-row">
						<div class="4u 12u(mobile)">
							...
							<section>
								...
								<p>This is <strong>Minimaxing</strong>, a fully responsive HTML5 site template designed by <a href="<?=SITE_TEMPLATE_PATH?>http://twitter.com/ajlkn">AJ</a> and released for free by <a href="<?=SITE_TEMPLATE_PATH?>http://html5up.net">HTML5 UP</a>. It features
								...
								<footer class="controls">
									<a href="<?=SITE_TEMPLATE_PATH?>http://html5up.net" class="button">More cool designs ...</a>
								</footer>
							</section>
						...
						<div class="4u 12u(mobile)">
							...
							<section>
								...
								<ul class="small-image-list">
									<li>
										<a href="#"><img src="/bitrix/templates/images/pic2.jpg" alt="" class="left" /></a>
										<h4>Jane Anderson</h4>
										<p>Varius nibh. Suspendisse vitae magna eget et amet mollis justo facilisis amet quis.</p>
									</li>
									<li>
										<a href="#"><img src="/bitrix/templates/images/pic1.jpg" alt="" class="left" /></a>
										<h4>James Doe</h4>
					...
					<div class="row main-row">
						<div class="6u 12u(mobile)">
							...
							<section>
								...
								<ul class="big-image-list">
									<li>
										<a href="#"><img src="/bitrix/templates/images/pic3.jpg" alt="" class="left" /></a>
									...
									<li>
										<a href="#"><img src="/bitrix/templates/images/pic4.jpg" alt="" class="left" /></a>
										<h3>Magna Gravida Dolore</h3>
										<p>Varius nibh. Suspendisse vitae magna eget et amet mollis justo
										facilisis amet quis consectetur in, sollicitudin vitae justo. Cras
										Maecenas eu arcu purus, phasellus fermentum elit.</p>
									...
									<li>
										<a href="#"><img src="/bitrix/templates/images/pic5.jpg" alt="" class="left" /></a>
										<h3>Magna Gravida Dolore</h3>
										<p>Varius nibh. Suspendisse vitae magna eget et amet mollis justo
										facilisis amet quis consectetur in, sollicitudin vitae justo. Cras
										Maecenas eu arcu purus, phasellus fermentum elit.</p>
						...
						<div class="6u 12u(mobile)">
							...
							<article class="blog-post">
								...
								<a href="#"><img src="/bitrix/templates/images/pic6.jpg" alt="" class="top blog-post-image" /></a>
								<h3>Magna Gravida Dolore</h3>
